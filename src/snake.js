...
function drawGame()
{
    ...
    context.canvas.width  = GAME_WIDTH * 16 ;
    context.canvas.height = GAME_HEIGHT * 16;
...
class Fruit
{
    ...
    draw(context) {
        ...
        context.beginPath()
        context.fillRect(this.x * 16 + 3, this.y * 16 + 3, 10, 10)
        context.fill()
    }
...
$(document).ready(() => {
    ...
    $(document).keydown((event) => {
        ...
        if([keyboard.arrowUp, keyboard.arrowRight, keyboard.arrowDown, keyboard.arrowLeft].indexOf(event.keyCode) > -1) {
